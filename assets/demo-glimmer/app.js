...
class DemoGlimmer extends Component {
    constructor(options) {
        super(options);
        this.fetchData();
    }
    fetchData() {
        return __awaiter(this, void 0, void 0, function* () {
            yield fetch('https://jsonplaceholder.typicode.com/posts/1').then(request => request.json()).then(({ title }) => this.title = title);
        });
    }
}
__decorate([tracked], DemoGlimmer.prototype, "title", void 0);

var __ui_components_DemoGlimmer_template__ = { "id": "A51ZV11x", "block": "{\"symbols\":[],\"statements\":[[6,\"h1\"],[8],[1,[20,\"title\"],false],[9],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/demo-glimmer/components/DemoGlimmer" } };

var moduleMap = { 'component:/demo-glimmer/components/DemoGlimmer': DemoGlimmer, 'template:/demo-glimmer/components/DemoGlimmer': __ui_components_DemoGlimmer_template__ };

var resolverConfiguration = { "app": { "name": "demo-glimmer", "rootName": "demo-glimmer" }, "types": { "application": { "definitiveCollection": "main" }, "component": { "definitiveCollection": "components" }, "component-test": { "unresolvable": true }, "helper": { "definitiveCollection": "components" }, "helper-test": { "unresolvable": true }, "renderer": { "definitiveCollection": "main" }, "template": { "definitiveCollection": "components" } }, "collections": { "main": { "types": ["application", "renderer"] }, "components": { "group": "ui", "types": ["component", "component-test", "template", "helper", "helper-test"], "defaultType": "component", "privateCollections": ["utils"] }, "styles": { "group": "ui", "unresolvable": true }, "utils": { "unresolvable": true } } };
